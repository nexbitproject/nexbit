...
#ifndef NEXBIT_ZNBCTRACKER_H
#define NEXBIT_ZNBCTRACKER_H
...
public:
    CzNBCTracker(std::string strWalletFile);
    ~CzNBCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNBCWallet* zNBCWallet = NULL);
