...
CLegacyZNexbitStake::CLegacyZNexbitStake(const libzerocoin::CoinSpend& spend)
{
...
CBlockIndex* CLegacyZNexbitStake::GetIndexFrom()
{
...
CAmount CLegacyZNexbitStake::GetValue() const
{
    return denom * COIN;
}

CDataStream CLegacyZNexbitStake::GetUniqueness() const
{
