// Copyright (c) 2017-2018 The NEXBIT developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NEXBIT_ZNBCWALLET_H
#define NEXBIT_ZNBCWALLET_H
...
public:
    CzNBCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNBC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNBC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
