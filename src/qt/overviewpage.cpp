...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(fUseBlackTheme ? QColor(33, 39, 48) : foreground);
        ...
        {
            foreground = option.palette.color(QPalette::Dark);
        }
        painter->setPen(fUseBlackTheme ? QColor(33, 39, 48) : foreground);
        ...
        painter->setPen(fUseBlackTheme ? QColor(227, 110, 3) : option.palette.color(QPalette::Dark));
    ...
    filter(0)
{
    ...
    if (fUseBlackTheme)
    {
        const char* whiteLabelQSS = "QLabel { color: rgb(33, 39, 48); }";
