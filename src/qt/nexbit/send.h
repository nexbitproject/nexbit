...
#include "qt/nexbit/contactsdropdown.h"
#include "qt/nexbit/sendmultirow.h"
#include "qt/nexbit/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(NBCGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onNBCSelected(bool _isNBC);
    void onSendClicked();
...
private:
    ...
    bool sendZnexbit(QList<SendCoinsRecipient> recipients);
