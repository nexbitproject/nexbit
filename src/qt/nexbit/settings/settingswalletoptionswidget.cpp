...
#include "qt/nexbit/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nexbit/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NBCGUI* _window, QWidget *parent) :
