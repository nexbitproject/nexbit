...
#include "qt/nexbit/settings/settingsnetworkwidget.h"
#include "qt/nexbit/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nexbit/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NBCGUI* _window, QWidget *parent) :
