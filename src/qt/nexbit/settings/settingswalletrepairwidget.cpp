...
#include "qt/nexbit/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nexbit/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NBCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NBCGUI::handleRestart()
