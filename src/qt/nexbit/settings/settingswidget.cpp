...
#include "qt/nexbit/settings/forms/ui_settingswidget.h"
#include "qt/nexbit/settings/settingsbackupwallet.h"
#include "qt/nexbit/settings/settingsbittoolwidget.h"
#include "qt/nexbit/settings/settingswalletrepairwidget.h"
#include "qt/nexbit/settings/settingswalletoptionswidget.h"
#include "qt/nexbit/settings/settingsmainoptionswidget.h"
#include "qt/nexbit/settings/settingsdisplayoptionswidget.h"
#include "qt/nexbit/settings/settingsmultisendwidget.h"
#include "qt/nexbit/settings/settingsinformationwidget.h"
#include "qt/nexbit/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(NBCGUI* parent) :
    PWidget(parent),
    ...
    if(mapper->submit()) {
        ...
        if (this->clientModel->getOptionsModel()->isRestartRequired()) {
            ...
            if (fAcceptRestart) {
                ...
                inform(tr("Options will be applied on nexbitt wallet restart"));
            }
        } else {
