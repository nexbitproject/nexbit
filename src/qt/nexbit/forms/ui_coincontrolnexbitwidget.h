/********************************************************************************
** Form generated from reading UI file 'coincontrolnexwidget.ui'
**
...
#ifndef UI_COINCONTROLNEXWIDGET_H
#define UI_COINCONTROLNEXWIDGET_H
...
class Ui_CoinControlnexbitWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlnexbitWidget)
    {
        if (CoinControlnexbitWidget->objectName().isEmpty())
            CoinControlnexbitWidget->setObjectName(QStringLiteral("CoinControlnexbitWidget"));
        CoinControlnexbitWidget->resize(918, 552);
        CoinControlnexbitWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlnexbitWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlnexbitWidget);
        ...
        retranslateUi(CoinControlnexbitWidget);

        QMetaObject::connectSlotsByName(CoinControlnexbitWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlnexbitWidget)
    {
        CoinControlnexbitWidget->setWindowTitle(QApplication::translate("CoinControlnexbitWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlnexbitWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlnexbitWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlnexbitWidget", "NBC:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlnexbitWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlnexbitWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlnexbitWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlnexbitWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlnexbitWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlnexbitWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlnexbitWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlnexbitWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlnexbitWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlnexbitWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlnexbitWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlnexbitWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlnexbitWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlnexbitWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlnexbitWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlnexbitWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlnexbitWidget: public Ui_CoinControlnexbitWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLNEXWIDGET_H
