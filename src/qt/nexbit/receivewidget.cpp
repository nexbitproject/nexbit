...
#include "qt/nexbit/forms/ui_receivewidget.h"
...
#include "qt/nexbit/addressholder.h"
...
ReceiveWidget::ReceiveWidget(NBCGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive NBC."));
