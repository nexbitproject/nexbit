...
#include "qt/nexbit/coldstakingwidget.h"
#include "qt/nexbit/forms/ui_coldstakingwidget.h"
#include "qt/nexbit/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/nexbit/requestdialog.h"
#include "qt/nexbit/tooltipmenu.h"
#include "qt/nexbit/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(NBCGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your NBCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept NBC delegation / Delegate NBC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select NBC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 NBC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
