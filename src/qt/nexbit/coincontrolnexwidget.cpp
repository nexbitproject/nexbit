...
#include "qt/nexbit/coincontrolnexbitwidget.h"
#include "qt/nexbit/forms/ui_coincontrolnexbitwidget.h"

CoinControlnexbitWidget::CoinControlnexbitWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlnexbitWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select NBC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("NBC");
    ...
    ui->labelValueAfter->setText("0.00 NBC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 NBC");
    ui->labelValueFee->setText("0.00 NBC");
...
CoinControlnexbitWidget::~CoinControlnexbitWidget()
{
    delete ui;
}
