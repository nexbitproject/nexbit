...
#include "config/nexbit-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalnexbit = 0;
    qint64 totalZnexbit = 0;
    QList<qreal> valuesnexbit;
    QList<qreal> valuesznexbit;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(NBCGUI* _window);
    ~DashboardWidget();
