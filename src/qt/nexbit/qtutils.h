...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, NBCGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, NBCGUI *gui, double posX = 3);
