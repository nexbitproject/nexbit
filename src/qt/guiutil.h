...
/** Utility functions used by the NEXBIT Qt UI.
 */
namespace GUIUtil
{
...
// Render NEXBIT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZnexbit = false);
...
// Parse "nexbit:" URI into recipient object, return true on successful parsing
