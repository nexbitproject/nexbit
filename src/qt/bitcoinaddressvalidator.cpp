...
// Copyright (c) 2015-2017 The NEXBIT developers
...
QValidator::State BitcoinAddressEntryValidator::validate(QString& input, int& pos) const
{
    ...
    for (int idx = 0; idx < input.size();) {
        ...
        // users unexbitpectedly getting away with typos that would normally
...
{
    Q_UNUSED(pos);
    // Validate the passed NEXBIT address
