...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nexbit Core nexbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nexbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nexbit transaction") + "\n" +
                               "  nexbit-tx [options] -create [commands]   " + _("Create hex-encoded nexbit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nexbit transaction
