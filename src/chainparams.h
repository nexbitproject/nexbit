 ...
 * NEXBIT system. There are three: the main network on which people trade goods
...
public:
    ...
    int NexbitBadBlockTime() const { return nNexbitBadBlockTime; }
    int NexbitBadBlocknBits() const { return nNexbitBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nNexbitBadBlockTime;
    unsigned int nNexbitBadBlocknBits;
