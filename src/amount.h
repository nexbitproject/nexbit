...
/** Amount in NBC (Can be negative) */
typedef int64_t CAmount;

static const CAmount COIN = 100000000;
static const CAmount CENT = 1000000;

/** No amount larger than this (in NBC) is valid in a single UTXO.
 *
 * Note that this constant is *not* the total money supply, which in NEXBIT
...
/**
 * Fee rate in NBC per kilobyte: CAmount / kB
 */
class CFeeRate
{
private:
