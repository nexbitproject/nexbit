...
extern UniValue setznexbitseed(const UniValue& params, bool fHelp);
extern UniValue getznexbitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznexbit(const UniValue& params, bool fHelp);
extern UniValue dznexbitstate(const UniValue& params, bool fHelp);
