...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NEXBIT features */
        {"nexbit", "listmasternodes", &listmasternodes, true, true, false},
        {"nexbit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nexbit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nexbit", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nexbit", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nexbit", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nexbit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nexbit", "masternodedebug", &masternodedebug, true, true, false},
        {"nexbit", "startmasternode", &startmasternode, true, true, false},
        {"nexbit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nexbit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nexbit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nexbit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nexbit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nexbit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nexbit", "preparebudget", &preparebudget, true, true, false},
        {"nexbit", "submitbudget", &submitbudget, true, true, false},
        {"nexbit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nexbit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nexbit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nexbit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nexbit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nexbit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nexbit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nexbit", "checkbudgets", &checkbudgets, true, true, false},
        {"nexbit", "mnsync", &mnsync, true, true, false},
        {"nexbit", "spork", &spork, true, true, false},
        {"nexbit", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getznexbitseed", &getznexbitseed, false, false, true},
        {"zerocoin", "setznexbitseed", &setznexbitseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznexbit", &searchdznexbit, false, false, true},
        {"zerocoin", "dznexbitstate", &dznexbitstate, false, false, true},
...
{
    return "> nexbit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13774/\n";
}
