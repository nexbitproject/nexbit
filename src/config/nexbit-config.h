/* src/config/nexbit-config.h.  Generated from nexbit-config.h.in by configure.  */
/* src/config/nexbit-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "NEXBIT Core 5.1.1"
