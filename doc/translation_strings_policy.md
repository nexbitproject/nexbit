...
This document provides guidelines for internationalization of the NEXBIT Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nexbit_en.ts` remains unchanged.
