...
The script [extract-osx-sdk.sh](https://github.com/nexbit-project/nexbit/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
nexbit/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/nexbit-project/nexbit/blob/master/doc/README_osx.md) for troubleshooting tips.