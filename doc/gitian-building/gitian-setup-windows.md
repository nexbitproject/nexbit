...
The build script we'll be using is contained in the NEXBIT github repository ([contrib/gitian-build.py](https://github.com/nexbit-project/nexbit/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the NEXBIT repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/NEXBIT-Project/NEXBIT/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, nexbit-detached-sigs, and nexbit GitHub repos.
