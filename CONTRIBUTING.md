...
[Translation Process](https://github.com/nexbit-project/nexbit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NEXBIT Core project, and is not to be
confused with overall NEXBIT Network Protocol consensus changes.
...
Where a patchset proposes to change the NEXBIT consensus, it must have been
