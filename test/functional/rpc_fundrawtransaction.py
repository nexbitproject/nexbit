...
class RawTransactionsTest(NexbitTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid nexbit address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid nexbit address" in e.error['message'])
