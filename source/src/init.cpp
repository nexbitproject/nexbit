...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: nexbit.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: nexbitd.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-timeout"))
    {
        ...
        if (nNewTimeout > 0 && nNewTimeout < 60000)
