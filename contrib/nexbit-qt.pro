...
RESOURCES += src/qt/nexbit.qrc src/qt/nexbit_locale.qrc

TRANSLATIONS += src/qt/locale/nexbit_bg.ts \
                src/qt/locale/nexbit_de.ts \
                src/qt/locale/nexbit_en.ts \
                src/qt/locale/nexbit_es.ts \
                src/qt/locale/nexbit_fi.ts \
                src/qt/locale/nexbit_fr.ts \
                src/qt/locale/nexbit_it.ts \
                src/qt/locale/nexbit_ja.ts \
                src/qt/locale/nexbit_pl.ts \
                src/qt/locale/nexbit_pt.ts \
                src/qt/locale/nexbit_ru.ts \
                src/qt/locale/nexbit_sk.ts \
                src/qt/locale/nexbit_sv.ts \
                src/qt/locale/nexbit_vi.ts \
                src/qt/locale/nexbit_zh_CN.ts \
                src/qt/locale/nexbit_zh_TW.ts
